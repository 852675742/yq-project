...
public enum MpErrorEnum {
     ...
     * 客服管理接口返回码
     */
    CODE_65400(65400, "API不可用，即没有开通/升级到新版客服功能"),
    CODE_65401(65401, "	无效客服帐号"),
    CODE_65403(65403, "	客服昵称不合法"),
    CODE_65404(65404, "	客服帐号不合法"),
    CODE_65405(65405, "帐号数目已达到上限，不能继续添加"),
    CODE_65406(65406, "	已经存在的客服帐号"),
    CODE_65407(65407, "	邀请对象已经是该公众号客服"),
    CODE_65408(65408, "本公众号已经有一个邀请给该微信"),
    CODE_65409(65409, "无效的微信号"),
    CODE_65410(65410, "邀请对象绑定公众号客服数达到上限（目前每个微信号可以绑定5个公众号客服帐号）"),
    CODE_65411(65411, "	该帐号已经有一个等待确认的邀请，不能重复邀请"),
    CODE_65412(65412, "	该帐号已经绑定微信号，不能进行邀请"),

    CODE_65402(65402, "客服帐号尚未绑定微信号，不能投入使用"),
    CODE_65413(65413, "不存在对应用户的会话信息"),
    CODE_65414(65414, "粉丝正在被其他客服接待"),
    CODE_65415(65415, "指定的客服不在线"),
    CODE_65416(65416, "查询参数不合法"),
    CODE_65417(65417, "查询时间段超出限制"),
    ...
    private final static Map<String, String> CODE_DESCRIPTION_MAP = new ConcurrentHashMap<>(MpErrorEnum.values().length);

    MpErrorEnum(int code, String description) {
        this.code = code;
    ...
    public static String getDescriptionByCode(String code) {
        if (CODE_DESCRIPTION_MAP.size() == 0) {
            MpErrorEnum[] values = MpErrorEnum.values();
            for (MpErrorEnum value : values) {
