...
public class MsgCrypt {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(MsgCrypt.class);
	 ...
	 */
	public MsgCrypt(String token, String encodingAesKey, String appId){
		this.token = token;
		this.appId = appId;
	...
	public String encryptMsg(String replyMsg, String timeStamp, String nonce) throws AesException {
		...
		// 生成发送的xml
		String result = this.generateXml(encrypt, signature, timeStamp, nonce);
		return result;
	}
	...
	public String decryptMsg(String msgSignature, String timeStamp, String nonce, String postData) throws AesException {
		...
		// 密钥，公众账号的app secret
		// 提取密文
		Document document = Utils.buildDocument(new ByteArrayInputStream(postData.getBytes()));
		//密文
		String encrypt = Utils.obtainFirstMatchResult(document,"xml/Encrypt");
	 ...
	 * @return 生成的xml字符串
	 */
	public  String generateXml(String encrypt, String signature,
	...
	/**
	 * 返回加密后的xml
	 * @param plainText 未加密的消息报文
	 * @throws AesException
     */
	public String generateEncryptedXml(String plainText) throws AesException {
		// 加密
		String encryptedXml = encrypt(getRandomStr(), plainText);
